      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between py-4 gap-4">
          ...
          <div className="flex items-center space-x-3 space-x-reverse flex-shrink-0">
            ...
            {/* Cart */}
            <Link to="/cart" className="relative text-gray-700 p-2 rounded-lg hover:bg-gray-100 transition-all duration-300 smooth-transition">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {getCartCount() > 0 && (
                <span 
                  key={getCartCount()} 
                  className="absolute -top-1 -right-1 bg-blue-500 text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center shadow-lg cart-badge-bounce gpu-accelerated"
                >
                  {getCartCount()}
                </span>
              )}
